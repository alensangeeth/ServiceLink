...
--
-- Host: localhost    Database: service_booking_platform
-- ------------------------------------------------------
...
CREATE TABLE `service_providers` (
  ...
  CONSTRAINT `service_providers_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-03-12 10:00:57
